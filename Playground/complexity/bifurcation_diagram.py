...
def plot_bifurcation_diagram(
    map_function, n: int = 100000, iterations: int = 10000
) -> plt:
    ...
    ax2.plot(
        r[lyapunov < 0], lyapunov[lyapunov < 0] / iterations, ".k", alpha=0.5, ms=0.5
    )
    ax2.plot(
...
if __name__ == "__main__":
    plot_bifurcation_diagram(logistic_map).savefig(
        "logistic_map_bifurcation_diagram.png"
    )
