...
def shannon_information_text(text: str) -> float:
    ...
    probabilities = [
        p / len(words_freq) * log2(p / len(words_freq)) for p in words_freq.values()
    ]
...
if __name__ == "__main__":
    print(
        shannon_information_text(
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi facilisis quam et "
