...
class NodesAPI:
    ...
    def add_node():
        ...
        def consensus():
            ...
            if replaced:
                response = {"message": "Our chain was replaced", "new_chain": bc.chain}
            else:
                response = {"message": "Our chain is authoritative", "chain": bc.chain}
        ...
        def start_all_nodes():
            threads = [
                Thread(
                    target=NodesAPI.start_node,
                    args=(NodesAPI.add_node(), "0.0.0.0", node[-4:]),
                )
